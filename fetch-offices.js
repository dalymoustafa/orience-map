...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("orience")
  );

  if (!record) { console.error("Could not find Orience!"); process.exit(1); }
...
<head>
  ...
  <title>Orience — Office Locations</title>
